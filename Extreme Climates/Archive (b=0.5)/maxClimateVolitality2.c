...
const int CLIMATES_TO_CHECK = WEIRDNESS;
...
int main() {
	...
	while (1) {
		...
		minOffsetsSum *= 1.5 * SUM * ((CLIMATES_TO_CHECK & TEMPERATURE) + (CLIMATES_TO_CHECK & HUMIDITY)
